(() => {
            ...
            return (function (e) {
                ...
                var r = n(1),
                  ...
                  l = function (e, t, n) {
                    var c,
                      ...
                      y = e & l.P,
                      b = e & l.B,
                      g = m ? r : v ? r[t] || (r[t] = {}) : (r[t] || {})[s],
                      _ = m ? o : o[t] || (o[t] = {}),
                      w = _[s] || (_[s] = {});
                    for (c in (m && (n = t), n))
                      (d = ((p = !h && g && void 0 !== g[c]) ? g : n)[c]),
                        (f =
                          b && p
                            ? u(d, r)
                            : y && "function" == typeof d
                    ...
                    null == s.nextSibling
                      ...
                      : ((c && c.length) || null != s) &&
                        (function (e, t, n, r, o) {
                                ...
                                for (i = g; i < w; i++)
                                  if (
                                    ...
                                    "number" == typeof p
                                      ...
                                      ? !c._componentConstructor &&
                                        m(c, p.nodeName)
                                      : d ||
                                        c._componentConstructor === p.nodeName)
                                  ) {
                                    (l = a),
                                      (h[i] = void 0),
                                      i === w - 1 && w--,
                          ...
                          if (b)
                            for (var S in v) void 0 !== v[S] && E(v[S], !1);
                          for (; g <= w; ) void 0 !== (l = h[w--]) && E(l, !1);
                        })(i, c, n, r, S || null != l.dangerouslySetInnerHTML),
                    (function (e, t, n) {
                      var r;
                      for (r in n)
                        (t && null != t[r]) ||
                ...
                function N(e, t, n) {
                  ...
                  for (
                    e.prototype && e.prototype.render
                      ? ((r = new e(t, n)), A.call(r, t, n))
                      : (((r = new A(t, n)).constructor = e), (r.render = k));
                    o--;
                ...
                function q(e, t, n, r) {
                  if (!e._disable) {
                    ...
                    if (
                      ...
                      (i = e.render(l, c, p)),
                        e.getChildContext &&
                          (p = s(s({}, p), e.getChildContext())),
                        m &&
                          e.getSnapshotBeforeUpdate &&
                          (M = e.getSnapshotBeforeUpdate(d, f));
                      var k,
                        A,
                        T = i && i.nodeName;
                      if ("function" == typeof T) {
                        var j = v(i);
                        (a = g) && a.constructor === T && j.key == a.__key
                          ? P(a, j, 1, p, !1)
                          : ((k = a),
                            (e._component = a = N(T, j, p)),
                        ...
                        (u = b),
                          ...
                          (b || 1 === t) &&
                            ...
                            (A = (function (e, t, n, r, o, i) {
                              ...
                              var a = C(e, t, n, r, true);
                              return (
                                o && a.parentNode !== o && o.appendChild(a),
                                --w || (S = !1),
                                a
                              );
                            })(u, i, p, n || !m, b && b.parentNode)));
                      if (b && A !== b && a !== g) {
                        var D = b.parentNode;
                        D &&
                          A !== D &&
                          (D.replaceChild(A, b),
                          k || ((b._component = null), E(b, !1)));
                      }
                      if ((k && I(k), (e.base = A) && !r)) {
                        for (var F = e, B = e; (B = B._parentComponent); )
                          (F = B).base = A;
                        (A._component = F),
                  ...
                  return function (t, u, h) {
                    for (
                      var m,
                        ...
                        _ = a(b.length),
                        w = 0,
                        x = n ? f(t, _) : s ? f(t, 0) : void 0;
                      w < _;
                      w++
                    )
                      if ((d || w in b) && ((v = g((m = b[w]), w, y)), e))
                        if (n) x[w] = v;
                        else if (v)
                          switch (e) {
                            case 3:
                ...
                var p = (function (e) {
                  ...
                  return (
                    ...
                    (n.handleInputBlur = function (e) {
                      ...
                      if (-1 === n) {
                        var u = r && c(),
                          s = c() ? i : this.templateInputValue(o[a]);
                    ...
                    (n.render = function () {
                      var e,
                        ...
                        N = x.ariaHint,
                        k = x.validChoiceMade,
                        P = this.hasAutoselect(),
                        q = -1 === S,
                        I = 0 === E.length,
                        A = 0 !== L.length,
                        T = L.length >= l,
                        j = this.props.showNoOptionsFound && q && I && A && T,
                        D = i + "__wrapper",
                        F = i + "__input",
                        B = null !== S ? " " + F + "--focused" : "",
                        R = this.props.showAllValues
                          ? " " + F + "--show-all-values"
                          : " " + F + "--default",
                        ...
                        W = i + "__menu",
                        H = W + "--" + a,
                        K = W + "--" + (C || j ? "visible" : "hidden"),
                        Q = i + "__option",
                        z = i + "__hint",
                        G = this.templateInputValue(E[M]),
                        $ =
                          G &&
                          0 === G.toLowerCase().indexOf(L.toLowerCase()) &&
                          P
                            ? L + G.substr(L.length)
                            : "",
                        J = s + "__assistiveHint",
                        X = N ? { "aria-describedby": J } : null;
                      return (
                        h &&
                          "string" == typeof (e = w({ className: U })) &&
                        ...
                        (0, r.createElement)(
                          ...
                          (0, r.createElement)(o.default, {
                            ...
                            minQueryLength: l,
                            selectedOption: this.templateInputValue(E[M]),
              ...
              function (e, t, n) {
                ...
                e.exports = n(3)
                  ...
                  : function (e, t) {
                      o(e);
                      for (var n, a = i(t), u = a.length, s = 0; s < u; )
                        r.f(e, (n = a[s++]), t[n]);
                      return e;
                    };
              },
                      ...
                      (n.componentWillMount = function () {
                        ...
                        this.debounceStatusUpdate = (function (e, t, n) {
                          ...
                          if (!e.state.debounced) {
                            var t =
                              !e.props.isInFocus || e.props.validChoiceMade;
  ...
  (n.n = (e) => {
    ...
    (() => {
      ...
      var e = n(221),
        t = n.n(e);
      const r = document.querySelector(".search-form"),
        o = [
          "Earth",
          "Jupiter",
          "Mars",
      ...
      t()({
        ...
        io("https://cosmos-odyssey-martinv.herokuapp.com/").on(
          "newPrices",
          function () {
            document.querySelector(".results-container").innerHTML =
        ...
        document
          ...
          .addEventListener("click", function () {
            r.classList.remove("selected--mobile");
            const e = document.querySelectorAll(".autocomplete__menu");
            e &&
              e.forEach(function (e) {
                e.classList.remove("autocomplete__menu--visible"),
                  e.classList.add("autocomplete__menu--hidden");
              });
          }),
        document.querySelectorAll(".autocomplete__input").forEach(function (e) {
          e.addEventListener("focus", function (e) {
            window.matchMedia("(max-width: 1120px)").matches
              ? (r.classList.remove("selected--desktop"),
                r.classList.add("selected--mobile"))
              : (r.classList.remove("selected--mobile"),
                r.classList.add("selected--desktop"));
          }),
        ...
        document
          ...
          .addEventListener("change", function (e) {
            ...
            n.searchParams.set("sort", t), (window.location = n), i();
          }),
        document
          .querySelector(".filtering-options")
          .addEventListener("change", function (e) {
            if (!e.target.classList.contains("company-filter")) return;
            const t = new URL(document.location.href);
            t.searchParams.delete("filter"),
              document
                .querySelectorAll(".company-filter")
                .forEach(function (e) {
                  e.checked || t.searchParams.append("filter", e.name);
                }),
        ...
        document
          ...
          .addEventListener("click", function (e) {
            const t = e.target;
            if (t.classList.contains("reserve-button")) {
              const e = document.querySelector(".reservation-container"),
                n = t.closest(".result-container"),
                r = n.querySelector(".reserve-button").dataset.id,
                o = n.querySelector(".result-company").innerText,
                i = n.querySelector(".result-time-text").innerText,
                a = n.querySelector(".result-price").innerText,
                u = n.querySelector(".result-dates-text").innerText,
                s = e.querySelector(".reservation-complete-button");
              (s.dataset.id = r),
                (s.dataset.companyName = o),
                (s.dataset.travelTime = i),
                (s.dataset.travelPrice = a),
                (s.dataset.travelDates = u),
        ...
        document
          ...
          .addEventListener("submit", function (e) {
            const t = e.target,
              n = t.querySelector(".reservation-complete-button").dataset.id,
              {
                from: r,
                to: o,
                distance: i,
              } = document.querySelector(".search-form").dataset,
              {
                travelTime: a,
                travelPrice: u,
                companyName: s,
            ...
            [
              ...
              (n.style.display = "none"),
                (n.name = Object.keys(e)[0]),
                (n.value = Object.values(e)[0]),
                t.appendChild(n);
            });
          }),
